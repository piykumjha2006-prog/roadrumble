...
var er = (t) => Ef(Fn({}, "__esModule", { value: true }), t);
var Tr;
var kt;
var Pt;
var kf;
...
var Ga = V(() => {
  ...
  La = (t, e) => {
    ...
    if (n != null) {
      ...
      let a = (e == null ? void 0 : e.format) !== void 0 ? e.format : "RGB", u = e == null ? void 0 : e.norm, d, c;
    ...
    if (r != null) {
      let o, i, a;
      (e == null ? void 0 : e.tensorLayout) !== void 0 && e.tensorLayout === "NHWC" ? (o = t.dims[2], i = t.dims[1], a = t.dims[3]) : (o = t.dims[3], i = t.dims[2], a = t.dims[1]);
...
var ms = V(() => {
  ...
  $t();
  kr();
  ls = "ort-wasm-proxy-worker", cs = ((_a = globalThis.self) == null ? void 0 : _a.name) === ls;
  cs && (self.onmessage = (t) => {
...
`));
  ...
  function M(s) {
    throw E(s = "Aborted(" + s + ")"), A = true, s = new WebAssembly.RuntimeError(s + ". Build with -sASSERTIONS for more info."), S == null ? void 0 : S(s), s;
  }
  function G() {
  ...
  async function be() {
    ...
    }) : o ? s(new WebAssembly.Instance(y, G()), y) : (ie ?? (ie = e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href), l = await (async function(f) {
      var $ = ie;
      if (!g && !D($)) try {
  ...
  }, Fp = !Atomics.waitAsync || ((_b2 = globalThis.navigator) == null ? void 0 : _b2.userAgent) && 91 > Number((navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./) || [])[2]);
  function En(s) {
...
`))[0] == "Error" && f.shift(), ki(f);
  ...
  var Bn, Mn = {}, Pi = () => {
    var _a3;
    if (!Bn) {
      var s, l = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (((_a3 = globalThis.navigator) == null ? void 0 : _a3.language) ?? "C").replace("-", "_") + ".UTF-8", _: "./this.program" };
  ...
  function Sr() {
    if (0 < ge) Te = Sr;
    else if (o) _ == null ? void 0 : _(e), $e();
    else {
      for (var s = Oe; 0 < s.length; ) s.shift()(e);
      0 < ge ? Te = Sr : (e.calledRun = true, A || ($e(), _ == null ? void 0 : _(e)));
    }
  }
...
var gs = V(() => {
  "use strict";
  var _a, _b2;
  Df = fs, zf = (_b2 = (_a = globalThis.self) == null ? void 0 : _a.name) == null ? void 0 : _b2.startsWith("em-pthread");
  zf && fs();
});
var _s;
var to;
...
var $t = V(() => {
  ...
  no = false, Nr = false, Ss = false, Nf = () => {
    ...
    let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, a = o == null ? void 0 : o.mjs, u = (a == null ? void 0 : a.href) ?? a, d = o == null ? void 0 : o.wasm, c = (d == null ? void 0 : d.href) ?? d, p = t.wasmBinary, [m, g] = await xs(u, i, r > 1, !!p || !!c), y = false, b = [];
...
var Is = V(() => {
  ...
  Ts = (t) => {
    ...
    try {
      ...
      let i = 0;
      return (t == null ? void 0 : t.tag) !== void 0 && (i = Ge(t.tag, n)), r = e._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && me("Can't create run options."), (t == null ? void 0 : t.extra) !== void 0 && nr(t.extra, "", /* @__PURE__ */ new WeakSet(), (a, u) => {
...
var Us = V(() => {
  ...
  zs = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Zf = (t, e) => {
    ...
    async ensureTensor(e, r, n, o) {
      ...
      if (!(a == null ? void 0 : a.input.dataTypes.includes(r))) {
        if (u = Xf.get(r), !u || (a == null ? void 0 : a.input.dataTypes.includes(u))) throw new Error(`WebNN backend does not support data type: ${r}`);
    ...
    async download(e) {
      ...
      if (this.activeUpload) {
        let r = ((_a = this.wrapper) == null ? void 0 : _a.isDataConverted) ? Bs(this.activeUpload, (_b2 = this.wrapper) == null ? void 0 : _b2.type) : this.activeUpload;
        if (e) {
...
var St = V(() => {
  ...
  Qe = (t, e, r = "f32") => {
    ...
    if (e === "HardSigmoid") {
      ...
      let [r, n] = (t == null ? void 0 : t.activation_params) || [Ps, Os];
...
var ml = V(() => {
  ...
  ko = "[a-zA-Z]|\\.\\.\\.", pn = "(" + ko + ")+", dl = "^" + pn + "$", xg = "(" + pn + ",)*" + pn, Sg = "^" + xg + "$", Po = class {
    ...
    constructor(e, r) {
      ...
      (_a = o.match(RegExp(ko, "g"))) == null ? void 0 : _a.forEach((u) => {
    ...
    let i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)), a = k.size(n), u = R("output", e, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
      ...
      r.symbolToInfo.forEach((E, A) => {
        ...
        if (r.rhs.symbolToIndices.has(A)) {
          let D = (_a = r.rhs.symbolToIndices.get(A)) == null ? void 0 : _a[0];
...
var Yc = V(() => {
  ...
  iy = (t, e) => {
    ...
    var _a, _b2;
    let n = t.name;
    return ((_a = t.shaderCache) == null ? void 0 : _a.hint) && (n += "[" + t.shaderCache.hint + "]"), n += ":" + r + `:${iy(e, ((_b2 = t.shaderCache) == null ? void 0 : _b2.inputDependencies) ?? new Array(e.length).fill("dims"))}`, n;
  }, Ro = class {
    constructor(e) {
    ...
    flush() {
      ...
      this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), e = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(e, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, e, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && e.mapAsync(GPUMapMode.READ).then(() => {
        ...
        for (let o = 0; o < r.length / 2; o++) {
          ...
          if ((_a = this.env.webgpu.profiling) == null ? void 0 : _a.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), outputsMetadata: g.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), kernelId: a, kernelType: d, kernelName: c, programName: p, startTime: _, endTime: S });
          else {
            let x = "";
            m.forEach((T, I) => {
...
var ep = V(() => {
  ...
  lr = class t {
    ...
    compute(e, r) {
      var _a;
      let n = ((_a = r == null ? void 0 : r.inputs) == null ? void 0 : _a.map((u) => typeof u == "number" ? this.inputs[u] : u)) ?? this.inputs, o = (r == null ? void 0 : r.outputs) ?? [], i = (u, d, c) => new lr(this.module, d, this.output(u, c), c), a = (u, d) => {
        let c = xt(u, d);
...
var Jn = V(() => {
  ...
  uy = (t, e) => {
    ...
    try {
      if ([a, d] = await Cs(e), (e == null ? void 0 : e.externalData) && o.mountExternalData) {
        let I = [];
      ...
      for (let I of (e == null ? void 0 : e.executionProviders) ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof I != "string") {
          let A = I, D = A == null ? void 0 : A.context, w = A == null ? void 0 : A.gpuDevice, U = A == null ? void 0 : A.deviceType, N = A == null ? void 0 : A.powerPreference;
      ...
      i = await o._OrtCreateSession(r, n, a), (_a = o.webgpuOnCreateSession) == null ? void 0 : _a.call(o, i), i === 0 && me("Can't create a session."), (_b2 = o.jsepOnCreateSession) == null ? void 0 : _b2.call(o), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
      let [m, g] = dy(i), y = !!(e == null ? void 0 : e.enableGraphCapture), b = [], _ = [], S = [], x = [], v = [];
      for (let I = 0; I < m; I++) {
        let [E, A, D] = tp(i, I);
      ...
      for (let I = 0; I < g; I++) {
        ...
        _.push(w), x.push(A === 0 ? { name: w, isTensor: false } : { name: w, isTensor: true, type: rt(A), shape: D });
        {
          ...
          let U = typeof (e == null ? void 0 : e.preferredOutputLocation) == "string" ? e.preferredOutputLocation : ((_c2 = e == null ? void 0 : e.preferredOutputLocation) == null ? void 0 : _c2[w]) ?? "cpu", N = o.webnnIsGraphOutput;
          if (U === "cpu" && N && N(i, w)) {
      ...
      o._free(r), a !== 0 && o._OrtReleaseSessionOptions(a) !== 0 && me("Can't release session options."), d.forEach((m) => o._free(m)), (_d2 = o.unmountExternalData) == null ? void 0 : _d2.call(o);
    }
  }, Br = (t) => {
    var _a, _b2, _c2;
    let e = ye(), r = Ut.get(t);
    ...
    let [n, o, i, a, u] = r;
    a && (u && e._OrtClearBoundOutputs(a.handle) !== 0 && me("Can't clear bound outputs."), e._OrtReleaseBinding(a.handle) !== 0 && me("Can't release IO binding.")), (_a = e.jsepOnReleaseSession) == null ? void 0 : _a.call(e, t), (_b2 = e.webnnOnReleaseSession) == null ? void 0 : _b2.call(e, t), (_c2 = e.webgpuOnReleaseSession) == null ? void 0 : _c2.call(e, t), o.forEach((d) => e._OrtFree(d)), i.forEach((d) => e._OrtFree(d)), e._OrtReleaseSession(n) !== 0 && me("Can't release session."), Ut.delete(t);
    ...
    try {
      ...
      if (g && !b) {
        ...
        for (let Z = 0; Z < S; Z++) {
          let ne = n[Z];
          ((_a = o[Z]) == null ? void 0 : _a[3]) ? (A.push(I[Z]), a._OrtBindOutput(L, m[ne], I[Z], 0) !== 0 && me(`Can't bind pre-allocated output[${Z}] for session=${t}.`)) : a._OrtBindOutput(L, m[ne], 0, X[ne]) !== 0 && me(`Can't bind output[${Z}] to ${Q[Z]} for session=${t}.`);
        }
        wt("wasm bindInputsOutputs"), Ut.set(t, [c, p, m, g, y, true]);
      }
      (_b2 = a.jsepOnRunStart) == null ? void 0 : _b2.call(a, c), (_c2 = a.webnnOnRunStart) == null ? void 0 : _c2.call(a, c);
      let q;
      ...
      for (let L = 0; L < S; L++) {
        ...
        try {
          ...
          ie = rt(M);
          let Oe = g == null ? void 0 : g.outputPreferredLocations[n[L]];
          if (ie === "string") {
      ...
      (_d2 = a.webnnOnRunEnd) == null ? void 0 : _d2.call(a, c), a.stackRestore(D), T.forEach((q) => a._OrtReleaseTensor(q)), I.forEach((q) => a._OrtReleaseTensor(q)), E.forEach((q) => a._free(q)), x !== 0 && a._OrtReleaseRunOptions(x), v.forEach((q) => a._free(q));
    }
  }, Rr = (t) => {
    let e = ye(), r = Ut.get(t);
  ...
  Nt = () => !!_e.wasm.proxy && typeof document < "u", cr = false, yn = false, _n = false, Lo = /* @__PURE__ */ new Map(), jt = (t, e) => {
    ...
    if (!yn) {
      ...
      if (cr = true, Nt()) return new Promise((t, e) => {
        Fe == null ? void 0 : Fe.terminate(), vs().then(([r, n]) => {
          try {
